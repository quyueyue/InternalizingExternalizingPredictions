...
FYP_output_dir = '/gpfs/milgram/project/holmes/yq222/FYP/FYP_output/'
mean_relevance_all_state_df = pd.read_csv(os.path.join(FYP_output_dir,'mean_activation_all_state_df_reordered_int_ext.csv'),header=None)
n_phenotype = mean_relevance_all_state_df.shape[1]
n_perm = 10000

internalizing_kid = ['cbcl_scr_syn_internal_r','cbcl_scr_syn_anxdep_r','cbcl_scr_syn_withdep_r','cbcl_scr_dsm5_depress_r','cbcl_scr_dsm5_anxdisord_r']
internalizing_parent = ['asr_scr_internal_r','asr_scr_anxdep_r','asr_scr_withdrawn_r','asr_scr_depress_r','asr_scr_anxdisord_r',
                   'asr_scr_avoidant_r','asr_scr_somatic_r','asr_scr_somaticpr_r']
externalizing_kid = ['cbcl_scr_syn_external_r','cbcl_scr_syn_rulebreak_r','cbcl_scr_syn_aggressive_r','cbcl_scr_dsm5_opposit_r','cbcl_scr_dsm5_conduct_r']
externalizing_parent = ['asr_scr_external_r','asr_scr_rulebreak_r','asr_scr_aggressive_r','asr_scr_antisocial_r']
...
np.savetxt(os.path.join(FYP_output_dir,"meandiff_perm_int_ext.csv"), meandiff_perm, delimiter=",")
...
np.savetxt(os.path.join(FYP_output_dir,"meandiff_observed_int_ext.csv"), meandiff_observed, delimiter=",")

function CBIG_TRBPC_prepare_PFM_perm_inputs_KRR(feature_files, KRR_dir, outdir)
...
%% get FC averaged in each network-pair blocks
load(feature_files);
...
for i = 1:N_fold
    load(fullfile(KRR_dir, 'y', ['fold_' num2str(i)], 'y_regress_all_score.mat'),'y_resid');
    y_regress{i} = y_resid;
end

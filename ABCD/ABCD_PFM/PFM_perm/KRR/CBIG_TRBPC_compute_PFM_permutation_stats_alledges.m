function CBIG_TRBPC_compute_PFM_permutation_stats(stacked_FC_mtx, y_file, krr_folds, ...
...
% Inputs:
%   - feature_files
%     A .mat file of dimensions ((87571*4) * N_sub), consisting of four FC
%     matrices stacked on top of each other, according to the order
%     specified in FC_all.mat
%
%   - y_file
...
for i = 1:perm_num
    ...
    for j = 1:N_fold
        ...
        features_train = stacked_FC_mtx(:,train_ind);
...
save([outdir '/PFM_score_perm_start_alledges' num2str(perm_seed_start) '.mat'],'PFM_score_perm');

function p_value = CBIG_MMP_compute_HCP_permutation_cod_p_value(ref_dir, behav_ind, outstem, perm_dir, seeds_total)
...
for i = 1:length(behav_ind)
    ...
    % load reference
    acc_vec = CBIG_MMP_HCP_read_model_results(outstem, ref_dir, seeds_total, N_folds, behav_ind, 'COD', 0);

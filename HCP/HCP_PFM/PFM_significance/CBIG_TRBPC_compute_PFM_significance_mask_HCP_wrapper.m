function hyp_driven_mask = CBIG_TRBPC_compute_PFM_significance_mask_HCP_wrapper(perm_dir, outdir)
...
if ~exist(fullfile(PFM_dir,'PFM_network_mean.mat'),'file')
    PFM_network = CBIG_TRBPC_compute_network_mean_PFM_HCP(PFM_dir, N_score, N_state, PFM_dir);
else

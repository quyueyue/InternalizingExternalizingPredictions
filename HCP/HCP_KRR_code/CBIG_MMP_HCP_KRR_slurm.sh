...
feature_path="$HCP_dir/HCP_data_inputs/features_rs_752"
...
subtxt="$HCP_dir/HCP_data_inputs/HCP_752_subjects.txt"
...
scorecsv="$HCP_dir/HCP_data_inputs/HCP_alldata.csv"

function CBIG_TRBPC_prepare_PFM_perm_inputs_HBN(feature_files, KRR_dir, outdir, seed_idx)
...
for i = 1:N_fold
    load(fullfile(KRR_dir, ['seed_' num2str(seed_idx)], 'results', 'y', ['fold_' num2str(i)], 'y_regress_KRR_HBN.mat'),'y_resid');
    y_regress{i} = y_resid;
end

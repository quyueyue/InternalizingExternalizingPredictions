function CBIG_TRBPC_compute_KRR_PFM_HBN( feature_file, KRR_dir, score_ind, outdir)
...
for j = 1:60 % 60=number of random seed replications
    for i = 1:10 % 10=number of folds
        ...
        load([KRR_dir '/seed_' num2str(j) '/results/final_result_KRR_HBN.mat']);
        load([KRR_dir '/seed_' num2str(j) '/results/y/fold_' num2str(i) '/y_regress_KRR_HBN.mat']);

...
HBN_KRR_PFM_dir='/gpfs/milgram/project/holmes/yq222/FYP/HBN/HBN_young_output_KRR/'
...
np.savetxt(os.path.join(HBN_KRR_PFM_dir,'exact_test/HBN_young_qvals_exact_test_int_ext.csv'),qvals_bin_mat_prop)
np.savetxt(os.path.join(HBN_KRR_PFM_dir,'exact_test/HBN_young_dir_exact_test_int_ext.csv'),dir_mat_prop)

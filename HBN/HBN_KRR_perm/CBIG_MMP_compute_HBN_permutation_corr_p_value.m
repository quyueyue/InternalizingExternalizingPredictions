function p_value = CBIG_MMP_compute_HBN_permutation_corr_p_value(ref_dir, behav_ind, outstem, perm_dir, seeds_total)
...
for i = 1:length(behav_ind)
    ...
    for curr_seed = 1:seeds_total
        ...
        % load permutations
        load(fullfile(perm_dir, outstem,seed_str, ['/acc_score' num2str(behav) '_allFolds_permStart1.mat']));
...
save(fullfile(perm_dir,'HBN_perm_pval.mat'),'p_value');

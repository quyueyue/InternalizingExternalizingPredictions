...
feature_path="$HBN_dir/fMRI_data/HBN_young_RSFC_combat.mat"
# CHANGE: specify the directory containing the results of the single-KRR model
outdir="$HBN_dir/HBN_young_output_KRR"
...
subtxt="$HBN_dir/behavioral_data/HBN_young_subjects.txt"

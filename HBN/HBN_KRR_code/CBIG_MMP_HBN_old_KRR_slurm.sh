...
feature_path="$HBN_dir/fMRI_data/HBN_old_RSFC_combat.mat"
...
subtxt="$HBN_dir/behavioral_data/HBN_old_subjects.txt"
...
scorecsv="$HBN_dir/behavioral_data/HBN_CBCL_old.csv"
